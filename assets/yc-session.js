...
(function () {
  ...
  const ROOT = (document.currentScript && document.currentScript.src.indexOf('/posts/') !== -1) ? '../' : '';
  ...
  function mount() {
    ...
    wrap.innerHTML = `
      ...
      <div class="yc-menu" id="ycMenu">
        ...
        ${role === 'admin' ? `<a href="${ROOT}admin.html">管理後台</a>` : ''}
        <a href="${ROOT}portfolios.html">組合實錄</a>
