...
(function () {
  ...
  const D = {
    ...
    /* ── 首頁 Slogan/CTA ── */
    'hero.slog':['Key to <b>Extraordinary Research</b><br>and Opensource Portfolio','Key to <b>Extraordinary Research</b><br>and Opensource Portfolio','Key to <b>Extraordinary Research</b><br>and Opensource Portfolio'],
    'hero.sub':['一個人的研究所：深度研報、三個實盤組合、全部方法論公開。買方立場，賣方紀律——每一個判斷背後都有真金白銀的倉位。','一个人的研究所：深度研报、三个实盘组合、全部方法论公开。买方立场，卖方纪律——每一个判断背后都有真金白银的仓位。','A one-person research house: deep-dive reports, three live portfolios, every methodology disclosed. Buy-side stance, sell-side discipline - real money behind every call.'],
    'hero.cta1':['免費註冊 · 解鎖完整研報庫與實時組合 →','免费注册 · 解锁完整研报库与实时组合 →','Sign up free · Unlock full research & live portfolios →'],
    'hero.cta2':['登入','登录','Login'],
    'hero.free':['FREE · 30 秒完成 · 歡迎抄作業','FREE · 30 秒完成 · 欢迎抄作业','FREE · 30 seconds · copying the homework is welcome'],
    'gate.title':['解鎖完整內容','解锁完整内容','Unlock the Full Content'],
    'gate.forum':['免費註冊即可閱讀全部深度研報與 PDF 原文——包括估值推導、風險量化與完整論證。','免费注册即可阅读全部深度研报与 PDF 原文——包括估值推导、风险量化与完整论证。','Sign up free to read every deep-dive report and full PDF - valuation work, risk quantification and the complete argument.'],
    'gate.pf':['免費註冊即可查看三個組合的完整檔案：淨值曲線、持倉明細、風險量化與每日自動更新的實時數據。','免费注册即可查看三个组合的完整档案：净值曲线、持仓明细、风险量化与每日自动更新的实时数据。','Sign up free to see the full profiles of all three portfolios - NAV curves, holdings, risk quantification and daily auto-updated live data.'],
    'gate.login':['已有帳號 · 登入','已有账号 · 登录','Have an account · Login'],
    'gate.signup':['免費註冊 →','免费注册 →','Sign up free →'],
    'gate.note':['FREE · 30 秒完成 · 條款寫明：歡迎抄作業','FREE · 30 秒完成 · 条款写明：欢迎抄作业','FREE · 30 seconds · the terms literally welcome copying the homework'],
    'gate.checking':['正在驗證帳戶','正在验证账户','Verifying your account'],
    'gate.checkingBody':['確認登入狀態後即會顯示完整內容。','确认登录状态后即会显示完整内容。','Full content will appear after your session is verified.'],
    /* ── 首頁 ── */
    ...
    'home.st.cum17':['累計回報','累计回报','Cumulative Return'],
    /* ── 研報庫 ── */
    ...
    'hk.desc':['做港股的週期均值回歸：在情緒與估值的極端處建倉，等待價格向長期均值收斂。高貝塔（beta）、高集中度，以無槓桿與安全邊際換取持有極端波動的資格。','做港股的周期均值回归：在情绪与估值的极端处建仓，等待价格向长期均值收敛。高贝塔（beta）、高集中度，以无杠杆与安全边际换取持有极端波动的资格。','Mean-reversion in HK cyclicals: positions built at sentiment and valuation extremes, held until price converges to long-run value. High beta, high concentration — no leverage and a margin of safety buy the right to sit through extreme volatility.'],
    ...
    'a.desc':['A股優質資產的長期持有：聚焦競爭格局清晰、自由現金流充沛的龍頭，換手極低、以年為單位計倉，用時間換取複利。','A股优质资产的长期持有：聚焦竞争格局清晰、自由现金流充沛的龙头，换手极低、以年为单位计仓，用时间换取复利。','Long-term ownership of quality A-shares: leaders with clear competitive structure and abundant free cash flow; minimal turnover, positions measured in years, compounding bought with time.'],
    ...
    'us.desc':['多資產配置的美金組合：股票、久期（duration）、黃金與短債的風險平衡，以厚尾（fat-tail）與壓力測試框架管理回撤，追求全天候的風險調整後回報。本板塊全部數字與圖表讀取後台持久化快照——','多资产配置的美金组合：股票、久期（duration）、黄金与短债的风险平衡，以厚尾（fat-tail）与压力测试框架管理回撤，追求全天候的风险调整后回报。本板块全部数字与图表读取后台持久化快照——','A multi-asset USD portfolio: risk balanced across equities, duration, gold and short-term bonds, with fat-tail and stress-testing frameworks governing drawdowns, pursuing all-weather risk-adjusted returns. Every number and chart in this section reads the persisted backend snapshot — '],
