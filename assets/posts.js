...
const POSTS = window.POSTS = [
  ...
  },
  {
    ...
    "excerpt": {
      ...
      "cn": "市场仍在用「逐款猜新游流水」的旧框架，预测一家增长主体已变成「长青池扩容」的公司。长青游戏 2024 年达 14 款且逐年净增，《王者荣耀》上线十年仍创流水新高、《三角洲行动》上线五个季度即入列——把收入改写为「长青款数 × 单款年金」后，两个因子都可以低风险外推。",
  ...
  },
  {
    ...
    "excerpt": {
      ...
      "cn": "商户费率约 0.6%、净费率仅万分之几，降费让利与断直连整改早已完成——监管在价格维度已无可再压，「压无可压」本身就是政策风险出清的状态。以五十至六十万亿元商业支付交易额计，净费率每上行万分之一即带来约 50–60 亿元近乎纯毛利的收入：市场按监管受害者定价，事实上它是监管出清后的幸存垄断者。",
